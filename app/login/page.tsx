    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-gray-500 mb-2">We sent a login link to:</p>
          <p className="font-medium text-blue-600 mb-6">{email}</p>
          <p className="text-sm text-gray-400">Click the link in your email to log in. The link expires in 15 minutes.</p>
          <button
