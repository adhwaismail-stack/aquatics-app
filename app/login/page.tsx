    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8">
          ...
          <button onClick={handleLogin} disabled={loading} className="w-full bg-blue-600 text-white py-3 rounded-lg font-medium hover:bg-blue-700 disabled:opacity-50">
            {loading ? 'Sending...' : 'Send Login Link'}
          </button>
          <p className="text-center text-sm text-gray-400 mt-4">No password needed. We email you a secure login link.</p>
        </div>
        <p className="text-center text-sm text-gray-400 mt-6">
          Don't have an account?{' '}
          <a href="/pricing" className="text-blue-600 hover:underline">Start free — no credit card needed</a>
        </p>
      </div>
    </div>
  )
