...
export default function HighDivingDemoChat(props: Props) {
  ...
  async function ask(question: string) {
    ...
    try {
      const res = await fetch("/api/demo", {
        ...
        body: JSON.stringify({ question: question, discipline: "high-diving" }),
      });
          ...
          <form onSubmit={handleSubmit} className="bg-white/5 border border-white/10 rounded-lg p-6">
            <div className="flex gap-3 items-center">
              <input
                ...
                placeholder={props.placeholder || "Ask anything about High Diving rules..."}
              />
              <button
                type="submit"
