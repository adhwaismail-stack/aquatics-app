...
import { paraSwimming } from "@/data/disciplines/para-swimming";
import FAQAccordion from "@/app/components/FAQAccordion";
import ParaSwimmingDemoChat from "@/app/components/ParaSwimmingDemoChat";

const d = paraSwimming;
...
const otherDisciplines = [
  ...
  { slug: "diving", name: "Diving", num: "05" },
...
export default function ParaSwimmingPage() {
  ...
  const faqPageSchema = {
    ...
    mainEntity: d.faqs.map((f) => ({
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: f.answer + " (Cited: World Para Swimming " + f.cite + ")",
      },
    })),
  };
    ...
    <>
      ...
      <main className="bg-aqua-paper text-aqua-ink font-body">
        ...
        <section className="border-b border-aqua-rule">
          <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20">
            <div className="font-cite text-xs text-aqua-pool-deep tracking-widest mb-8">
              LANE 08 — {d.heroEyebrow}
            </div>
            <h1 className="font-display text-5xl sm:text-7xl leading-tight mb-7 max-w-4xl">
              {d.name} Rules — Ask Anything
            </h1>
            <p className="text-lg sm:text-xl text-aqua-ink-soft max-w-2xl mb-6">
              {d.heroSub}
            </p>
            <div className="max-w-2xl mb-10 p-4 border-l-4 border-aqua-pool bg-aqua-pool-tint rounded-r">
              <div className="font-cite text-xs tracking-widest text-aqua-pool-deep mb-1">
                GOVERNANCE NOTE
              </div>
              <p className="text-sm text-aqua-ink leading-relaxed">
                Para Swimming is governed by <strong>World Para Swimming (WPS)</strong> under the
                <strong> International Paralympic Committee (IPC)</strong> — separate from World Aquatics.
                All citations on this page reference the <em>World Para Swimming Rules &amp; Regulations
                (February 2026)</em>.
              </p>
            </div>
        ...
        <section id="demo" className="bg-aqua-ink text-aqua-paper py-20">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            ...
            <p className="text-aqua-paper/70 max-w-2xl mb-12 text-lg">
              Two free questions, no signup required. Each answer cites the specific World Para Swimming article it draws from.
            </p>
            <ParaSwimmingDemoChat placeholder={d.demoPlaceholder} suggestedQuestions={d.suggestedQuestions} />
          </div>
        </section>

        <section className="py-24">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            <div className="font-cite text-xs text-aqua-pool-deep tracking-widest mb-4">08 — KEY CALLS</div>
        ...
        <section className="bg-aqua-paper-deep py-24">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            <div className="font-cite text-xs text-aqua-pool-deep tracking-widest mb-4">09 — FAQ</div>
            <h2 className="font-display text-4xl sm:text-5xl max-w-3xl mb-6">
              Real questions parents, coaches, and officials actually ask.
            </h2>
            <p className="max-w-2xl text-aqua-ink-soft text-lg mb-14">
              Each answer is grounded in a specific World Para Swimming article. Tap any to expand.
            </p>
        ...
        <section className="py-20 border-y border-aqua-rule">
          <div className="max-w-6xl mx-auto px-5 sm:px-8 grid grid-cols-1 sm:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="font-cite text-xs text-aqua-ink-soft mt-2 leading-relaxed">
                {d.rulebookCycle}
              </div>
            </div>
            <div>
        ...
        <section className="py-24">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            <div className="font-cite text-xs text-aqua-pool-deep tracking-widest mb-4">10 — DISCIPLINES</div>
        ...
        <footer className="bg-aqua-ink text-aqua-paper/70 py-16">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            ...
            <div className="border-t border-white/10 pt-6 text-xs font-cite">
              2026 AquaRef. Para Swimming content built on World Para Swimming (WPS / IPC) regulations.
            </div>
          </div>
        </footer>
