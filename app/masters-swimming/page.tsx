...
import { mastersSwimming } from "@/data/disciplines/masters-swimming";
import FAQAccordion from "@/app/components/FAQAccordion";
import MastersSwimmingDemoChat from "@/app/components/MastersSwimmingDemoChat";

const d = mastersSwimming;
...
export default function MastersSwimmingPage() {
  const webPageSchema = {
      ...
      <main className="bg-aqua-paper text-aqua-ink font-body">
        ...
        <section id="demo" className="bg-aqua-ink text-aqua-paper py-20">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            ...
            <MastersSwimmingDemoChat placeholder={d.demoPlaceholder} suggestedQuestions={d.suggestedQuestions} />
          </div>
        </section>

        <section className="py-24">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            <div className="font-cite text-xs text-aqua-pool-deep tracking-widest mb-4">02 — KEY CALLS</div>
        ...
        <section className="bg-aqua-paper-deep py-24">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            ...
            <h2 className="font-display text-4xl sm:text-5xl max-w-3xl mb-6">
              Real questions Masters swimmers, coaches, and officials actually ask.
            </h2>
            <p className="max-w-2xl text-aqua-ink-soft text-lg mb-14">
