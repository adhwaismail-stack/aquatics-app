      ...
      <main style={{ maxWidth: '680px', margin: '0 auto', padding: '3rem 1.5rem', fontFamily: 'sans-serif', color: '#1a1a2e' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '2.5rem' }}>
          ...
          <div style={{ background: '#f5f0ff', border: '1px solid #d5c5f0', borderRadius: '10px', padding: '1.25rem' }}>
            ...
            <a href="mailto:hello@aquaref.co?subject=AquaRef%20Partner%20Plan%20Inquiry" style={{ color: '#03045e', fontWeight: '600', fontSize: '15px', textDecoration: 'none' }}>hello@aquaref.co</a>
        ...
        <div style={{ marginBottom: '2.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <FaqItem
              ...
              a="Yes! We have a PARTNER plan for organizations of all sizes — from local clubs to national federations. It includes event management tools, live notices, and custom branding. Email hello@aquaref.co for a custom quote."
            />
            <FaqItem
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div>
                ...
                <input type="text" placeholder="Your name" style={{ width: '100%', padding: '10px 12px', border: '1px solid #ccc', borderRadius: '8px', fontSize: '14px', color: '#333', boxSizing: 'border-box', outline: 'none', background: '#fff' }} />
              </div>
              <div>
                <label style={{ fontSize: '13px', fontWeight: '600', color: '#444', display: 'block', marginBottom: '6px' }}>Email</label>
                <input type="email" placeholder="your@email.com" style={{ width: '100%', padding: '10px 12px', border: '1px solid #ccc', borderRadius: '8px', fontSize: '14px', color: '#333', boxSizing: 'border-box', outline: 'none', background: '#fff' }} />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <textarea placeholder="Describe your issue or question..." rows={5} style={{ width: '100%', padding: '10px 12px', border: '1px solid #ccc', borderRadius: '8px', fontSize: '14px', color: '#333', boxSizing: 'border-box', resize: 'vertical', outline: 'none', fontFamily: 'sans-serif', background: '#fff' }} />
            </div>
