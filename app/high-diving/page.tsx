...
import { highDiving } from "@/data/disciplines/high-diving";
import FAQAccordion from "@/app/components/FAQAccordion";
import HighDivingDemoChat from "@/app/components/HighDivingDemoChat";
...
export default function HighDivingPage() {
  const webPageSchema = {
      ...
      <main className="bg-aqua-paper text-aqua-ink font-body">
        ...
        <section id="demo" className="bg-aqua-ink text-aqua-paper py-20">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            ...
            <HighDivingDemoChat placeholder={d.demoPlaceholder} suggestedQuestions={d.suggestedQuestions} />
          </div>
        </section>
