...
import { artisticSwimming } from "@/data/disciplines/artistic-swimming";
import FAQAccordion from "@/app/components/FAQAccordion";
import ArtisticSwimmingDemoChat from "@/app/components/ArtisticSwimmingDemoChat";

const d = artisticSwimming;
...
export default function ArtisticSwimmingPage() {
  const webPageSchema = {
      ...
      <main className="bg-aqua-paper text-aqua-ink font-body">
        ...
        <section id="demo" className="bg-aqua-ink text-aqua-paper py-20">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            ...
            <ArtisticSwimmingDemoChat placeholder={d.demoPlaceholder} suggestedQuestions={d.suggestedQuestions} />
          </div>
        </section>

        <section className="py-24">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            <div className="font-cite text-xs text-aqua-pool-deep tracking-widest mb-4">04 — KEY CALLS</div>
        ...
        <section className="bg-aqua-paper-deep py-24">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            <div className="font-cite text-xs text-aqua-pool-deep tracking-widest mb-4">05 — FAQ</div>
            <h2 className="font-display text-4xl sm:text-5xl max-w-3xl mb-6">
        ...
        <section className="py-24">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            <div className="font-cite text-xs text-aqua-pool-deep tracking-widest mb-4">06 — DISCIPLINES</div>
