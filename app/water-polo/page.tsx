...
import { waterPolo } from "@/data/disciplines/water-polo";
import FAQAccordion from "@/app/components/FAQAccordion";
import WaterPoloDemoChat from "@/app/components/WaterPoloDemoChat";
      ...
      <main className="bg-aqua-paper text-aqua-ink font-body">
        ...
        <section id="demo" className="bg-aqua-ink text-aqua-paper py-20">
          <div className="max-w-6xl mx-auto px-5 sm:px-8">
            ...
            <WaterPoloDemoChat placeholder={d.demoPlaceholder} suggestedQuestions={d.suggestedQuestions} />
          </div>
        </section>
